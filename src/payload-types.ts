...
export interface Customer {
  ...
  customerName: string;
  /**
   * Harap Upload format PNG dengan background transparant
   */
  customerLogo: number | Media;
  websiteUrl?: string | null;
  /**
   * Centang untuk menampilkan Customer di carousel
   */
...
export interface Gallery {
  ...
  image: number | Media;
  /**
   * Deskripsi akan muncul saat hover
   */
  description?: string | null;
  /**
